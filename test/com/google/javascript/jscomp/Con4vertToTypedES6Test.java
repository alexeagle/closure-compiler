 ...
 */
public class Con4vertToTypedES6Test extends TestCase {
  ...
  public Node compile(String js) {
    ...
    CompilerPass pass = new Con4vertToTypedES6(compiler);
    pass.process(
  ...
  private static class FindNode extends NodeTraversal.AbstractPostOrderCallback
  {
    ...
    public void visit(NodeTraversal t, Node n, Node parent) {
      // Return type is attached to FUNCTION node,
      // but the qualifiedName is on the child NAME node.
      if (parent != null &&
          parent.isFunction() &&
